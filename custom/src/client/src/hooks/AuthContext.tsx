...
const AuthContextProvider = ({
  ...
  const isCustomRole = !!(isAuthenticated && userRoleName && userRoleName !== SystemRoles.USER && userRoleName !== SystemRoles.ADMIN);
  const { data: customRole = null } = useGetRole(userRoleName ?? '', {
  ...
  const memoedValue = useMemo(
    () => ({
      ...
      roles: {
        ...
        ...(isCustomRole && customRole ? { [userRoleName as string]: customRole } : {}),
      },
      isAuthenticated,
    }),

    [user, error, isAuthenticated, token, userRole, adminRole, customRole, isCustomRole, userRoleName],
  );
